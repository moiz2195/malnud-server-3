...
router.post('/adduser', asyncerror(async (req, res, next) => {
    ...
    if (req.body.id_front !== '') {
        result = await cloudinary.v2.uploader.upload(req.body.id_front, {
            folder: 'id'
        })
    ...
    if (req.body.id_back !== '') {
        ...
        result2 = await cloudinary.v2.uploader.upload(req.body.id_back, {
            folder: 'id'
        })
    ...
    if (req.body.profile !== '') {
        ...
        result3 = await cloudinary.v2.uploader.upload(req.body.profile, {
            folder: 'profile'
        });
